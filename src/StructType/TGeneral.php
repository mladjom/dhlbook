...
/**
 * This class stands for tGeneral StructType
 * @subpackage Structs
 * @date 2016-09-09
 * @author Mladjo
 * @release 1.0.0
 */
class TGeneral extends AbstractStructBase
{
    /**
     * The PickupDate
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \DHLBook\StructType\TDelivery
     */
    public $Delivery;
    /**
     * Constructor method for tGeneral
     * @uses TGeneral::setPickupDate()
     * @uses TGeneral::setCustomerID()
     * @uses TGeneral::setNote1()
     * @uses TGeneral::setNote2()
     * @uses TGeneral::setFreightNo()
     * @uses TGeneral::setWeight()
     * @uses TGeneral::setVolume()
     * @uses TGeneral::setLoadingmeter()
     * @uses TGeneral::setNoItems()
     * @uses TGeneral::setNoPallets()
     * @uses TGeneral::setPalletPlace()
     * @uses TGeneral::setCustomerRef()
     * @uses TGeneral::setGoodsCode()
     * @uses TGeneral::setOption1()
     * @uses TGeneral::setOption2()
     * @uses TGeneral::setOption3()
     * @uses TGeneral::setOption4()
     * @uses TGeneral::setOption5()
     * @uses TGeneral::setOption6()
     * @uses TGeneral::setOption7()
     * @uses TGeneral::setOption8()
     * @uses TGeneral::setOption9()
     * @uses TGeneral::setOption10()
     * @uses TGeneral::setOption11()
     * @uses TGeneral::setOption12()
     * @uses TGeneral::setOption13()
     * @uses TGeneral::setOption14()
     * @uses TGeneral::setOption15()
     * @uses TGeneral::setProductCode()
     * @uses TGeneral::setFreightPayer()
     * @uses TGeneral::setPickup()
     * @uses TGeneral::setDelivery()
     ...
     * @param \DHLBook\StructType\TDelivery $delivery
     */
    public function __construct($pickupDate = null, $customerID = null, $note1 = null, $note2 = null, $freightNo = null, \DHLBook\StructType\TWeight $weight = null, \DHLBook\StructType\TVolume $volume = null, \DHLBook\StructType\TLoadingmeter $loadingmeter = null, $noItems = null, $noPallets = null, \DHLBook\StructType\TPalletPlace $palletPlace = null, $customerRef = null, $goodsCode = null, $option1 = null, $option2 = null, $option3 = null, $option4 = null, $option5 = null, $option6 = null, $option7 = null, $option8 = null, $option9 = null, $option10 = null, $option11 = null, $option12 = null, $option13 = null, $option14 = null, $option15 = null, $productCode = null, $freightPayer = null, \DHLBook\StructType\TPickup $pickup = null, \DHLBook\StructType\TDelivery $delivery = null)
    {
        $this
     ...
     * @param string $pickupDate
     * @return \DHLBook\StructType\TGeneral
     */
    ...
    /**
     * Get Delivery value
     * @return \DHLBook\StructType\TDelivery|null
     */
     ...
     * @return \DHLBook\StructType\TGeneral
     */
    public function setDelivery(\DHLBook\StructType\TDelivery $delivery = null)
    {
