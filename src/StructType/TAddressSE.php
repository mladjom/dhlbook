...
/**
 * This class stands for tAddressSE StructType
 * @subpackage Structs
 * @date 2016-09-09
 * @author Mladjo
 * @release 1.0.0
 */
class TAddressSE extends AbstractStructBase
{
    /**
     * The Name
    ...
    public $City;
    /**
     * Constructor method for tAddressSE
     * @uses TAddressSE::setName()
     * @uses TAddressSE::setAddressLine()
     * @uses TAddressSE::setPostCode()
     * @uses TAddressSE::setCity()
     * @param string $name
     ...
     * Set Name value
     * @param string $name
     * @return \DHLBook\StructType\TAddressSE
     */
