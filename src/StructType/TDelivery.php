...
/**
 * This class stands for tDelivery StructType
 * @subpackage Structs
 * @date 2016-09-09
 * @author Mladjo
 * @release 1.0.0
 */
class TDelivery extends AbstractStructBase
{
    /**
     * The Address
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \DHLBook\StructType\TAddressGeneric
     */
    public $Address;
    /**
     * The Contact
    ...
    public $OpenHourStop;
    /**
     * Constructor method for tDelivery
     * @uses TDelivery::setAddress()
     * @uses TDelivery::setContact()
     * @uses TDelivery::setPhoneNo()
     * @uses TDelivery::setOpenHourStart()
     * @uses TDelivery::setOpenHourStop()
     * @param \DHLBook\StructType\TAddressGeneric $address
     * @param string $contact
     * @param string $phoneNo
     * @param string $openHourStart
     * @param string $openHourStop
     */
    public function __construct(\DHLBook\StructType\TAddressGeneric $address = null, $contact = null, $phoneNo = null, $openHourStart = null, $openHourStop = null)
    {
        $this
            ->setAddress($address)
            ->setContact($contact)
    ...
    /**
     * Get Address value
     * @return \DHLBook\StructType\TAddressGeneric|null
     */
     ...
     * Set Address value
     * @param \DHLBook\StructType\TAddressGeneric $address
     * @return \DHLBook\StructType\TDelivery
     */
    public function setAddress(\DHLBook\StructType\TAddressGeneric $address = null)
    {
